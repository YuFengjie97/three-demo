...
}`;function M(){const o=n.useMemo(()=>{const i=new y(10,10,300,300),c=b(i);return c.computeTangents(),i.dispose(),c},[]),a=w(),t=n.useMemo(()=>({...a,uDepthCol:{value:new x(1449539)},uSurfaceCol:{value:new x(56319)}}),[]),{depthCol:r,surfaceCol:s,metalness:v,roughness:m}=C({surfaceCol:"#"+t.uSurfaceCol.value.getHexString(),depthCol:"#"+t.uDepthCol.value.getHexString(),metalness:{value:.5,min:0,max:1},roughness:{value:0,min:0,max:1}});return n.useEffect(()=>{t.uDepthCol.value.set(r),t.uSurfaceCol.value.set(s)},[r,s,t]),e.jsx(e.Fragment,{children:e.jsx("mesh",{geometry:o,rotation:[-Math.PI/2,0,0],children:e.jsx(z,{baseMaterial:h,vertexShader:S,fragmentShader:L,uniforms:t,side:d,metalness:v,roughness:m})})})}function _(){const o=n.useRef(null);return D(o,g,1),f((a,t)=>{const{clock:r}=a,s=r.getElapsedTime();o.current.position.x=Math.cos(s)*3,o.current.position.z=Math.sin(s)*3}),e.jsx(e.Fragment,{children:e.jsx("directionalLight",{ref:o,position:[0,2,0]})})}const Y=l(function(){return console.log("sea page console test"),e.jsx(e.Fragment,{children:e.jsx("div",{className:"h-screen",children:e.jsxs(p,{camera:{position:[0,2,4]},children:[e.jsx(j,{position:"top-left"}),e.jsx("ambientLight",{}),e.jsx(_,{}),e.jsx("axesHelper",{args:[20]}),e.jsx(u,{}),e.jsx(M,{})]})})})});export{Y as default};
