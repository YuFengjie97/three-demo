import{w as j,o as e,r as u}from"./chunk-EPOLDU6W-D-U-5P6E.js";import{C as A,u as z,b as D}from"./extends-CQKH8FHF.js";import{u as g}from"./useUniformTime-p2f39nCE.js";import{u as L}from"./leva.esm-CD9oxMAJ.js";import{d as P,w as T}from"./index-DPw2RNN1.js";import{a as S}from"./asset-BvcpElq9.js";import{O as _}from"./OrbitControls-Df7v6KnC.js";import{L as M}from"./Loader-DtNERok4.js";import{u as I}from"./Gltf-ChqwI0vI.js";import{e as h,U as p,A as F,B as G}from"./three.module-CqEfS7dP.js";import{G as V}from"./GPUComputationRenderer-Co-SdBup.js";import"./index-7OC5HNn7.js";import"./index-D369hMBv.js";import"./client-EdRjCdko.js";import"./index-n5PR1bfd.js";import"./constants-XW_pBG14.js";const E=`#define GLSLIFY 1
//
...
}`,{ceil:C,floor:O,random:w,sqrt:b}=Math;function Y(i){const a=i.getAttribute("position"),t=a.array,v=a.count,r=C(b(v)),{gl:y}=D(),l=o=>{const x=o.image.data;for(let s=0;s<v;s++){const d=s*4,f=s*3;x[d+0]=t[f+0],x[d+1]=t[f+1],x[d+2]=t[f+2],x[d+3]=w()}},n=g(),{gpu:m,posVar:c}=u.useMemo(()=>{const o=new V(r,r,y),x=o.createTexture();l(x);const s=o.addVariable("posTex",N,x);return o.setVariableDependencies(s,[s]),s.material.uniforms={...n,defPos:new p(x),lifeSpeed:new p(1),particleVel:new p(2.5)},o.init(),{gpu:o,posVar:s}},[r]);return L({lifeSpeed:{value:c.material.uniforms.lifeSpeed.value,min:.1,max:4,step:.01,onChange(o){c.material.uniforms.lifeSpeed.value=o}},particleVel:{value:2.5,min:.1,max:10,step:.01,onChange(o){c.material.uniforms.particleVel.value=o}}}),{gpu:m,posVar:c,count:v,size:r}}function U(){const{nodes:i,materials:a}=I(S("/model/universe-transformed.glb")),t=i.universe.geometry;return t.setIndex(null),t}function W(){const{geo:i}=u.useMemo(()=>{const r=U(),l=r.getAttribute("position").count,n=C(b(l)),m=new Float32Array(l*2);for(let c=0;c<l;c++){const o=O(c/n),x=c-o*n,s=c*2;m[s+0]=(x+.5)/n,m[s+1]=(o+.5)/n}return r.setAttribute("pCoord",new h(m,2)),{geo:r}},[]),{gpu:a,posVar:t}=Y(i),v={size:new p(10),gpuPos:new p(a.getCurrentRenderTarget(t).texture)};return z(()=>{a.compute()}),e.jsx("points",{geometry:i,scale:10,children:e.jsx("shaderMaterial",{uniforms:v,vertexShader:E,fragmentShader:q,transparent:!0,depthWrite:!1,blending:F})})}function k(){return e.jsxs("mesh",{children:[e.jsx("icosahedronGeometry",{args:[.1,2]}),e.jsx("meshBasicMaterial",{toneMapped:!1,color:[10,10,10]})]})}function H(){const i=u.useMemo(()=>{const v=new G,r=300,y=new Float32Array(r*3);v.setAttribute("position",new h(y,3));const l=new Float32Array(r);for(let n=0;n<r;n++)l[n]=w();return v.setAttribute("aLife",new h(l,1)),v},[]),t={...g(),size:new p(100)};return e.jsx("points",{geometry:i,children:e.jsx("shaderMaterial",{uniforms:t,vertexShader:R,fragmentShader:B,transparent:!0,depthWrite:!1})})}function J(){const i=u.useRef(null);return z((a,t)=>{i.current.rotation.y-=t*.1}),e.jsxs("group",{ref:i,rotation:[.4,0,-.5],children:[e.jsx(W,{}),e.jsx(k,{}),e.jsx(H,{})]})}const le=j(function(){return e.jsxs("div",{className:"h-screen",children:[e.jsxs(A,{camera:{position:[0,2,6]},children:[e.jsx(_,{target:[0,1,0]}),e.jsx(u.Suspense,{fallback:null,children:e.jsx(J,{})}),e.jsx(P,{children:e.jsx(T,{})})]}),e.jsx(M,{})]})});export{le as default};
