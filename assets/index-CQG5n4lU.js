import{w as V,o as e,r as g}from"./chunk-EPOLDU6W-D-U-5P6E.js";import{C as M,u as I,b as P}from"./extends-CQKH8FHF.js";import{a as D}from"./asset-BvcpElq9.js";import{d as L,w as A}from"./index-DPw2RNN1.js";import{j as F}from"./three-custom-shader-material.es-3-1qXxK2.js";import{u as C}from"./useUniformTime-p2f39nCE.js";import{u as G}from"./leva.esm-CD9oxMAJ.js";import{u as w}from"./Gltf-ChqwI0vI.js";import{O as E}from"./OrbitControls-Df7v6KnC.js";import{L as U}from"./Loader-DtNERok4.js";import{c as Y,b as _}from"./Instances-CLupAcU1.js";import{U as u,b as q,c as N}from"./three.module-CqEfS7dP.js";import{G as O}from"./GPUComputationRenderer-Co-SdBup.js";import"./index-7OC5HNn7.js";import"./three-custom-shader-material.es-ClleyNLK.js";import"./index-D369hMBv.js";import"./client-EdRjCdko.js";import"./index-n5PR1bfd.js";import"./constants-XW_pBG14.js";const B=`#define GLSLIFY 1
uniform float uTime;
...
}`,{random:d,sqrt:z,ceil:b,floor:H}=Math,S=D("/model/sword-transformed.glb");w.preload(S);function J(x){const t=x.image.data;for(let r=0;r<t?.length;r++){const a=r*4,v=(d()-.5)*2*50,c=(d()-.5)*2*50,l=(d()-.5)*2*50;t[a+0]=v,t[a+1]=c,t[a+2]=l,t[a+3]=r}}function K(x){const t=x.image.data;for(let r=0;r<t?.length;r++){const a=r*4;t[a+0]=(d()-.5)*2,t[a+1]=(d()-.5)*2,t[a+2]=(d()-.5)*2,t[a+3]=r}}function Q(x){const{gl:t}=P(),r=b(z(x)),a=C(),{gpu:v,posVar:c,velVar:l}=g.useMemo(()=>{const i=new O(r,r,t),o=i.createTexture();J(o);const h=i.createTexture();K(h);const m=i.addVariable("texPos",k,o),s=i.addVariable("texVel",X,h);return m.material.uniforms={...a},s.material.uniforms={...a,uSize:new u(r),uSeparationR:new u(5),uAlignmentR:new u(10),uCohesionR:new u(10),uCenterEdge:new u(120),uMinSpeed:new u(20),uMaxSpeed:new u(40)},i.setVariableDependencies(m,[m,s]),i.setVariableDependencies(s,[m,s]),i.init(),{gpu:i,posVar:m,velVar:s}},[t,r]);return{gpu:v,posVar:c,velVar:l}}function W(){const{nodes:x,materials:t}=w(S),[r,a]=Y(),v=800,c=b(z(v)),{gpu:l,posVar:i,velVar:o}=Q(v),m={...C(),uTexPos:new u(l.getCurrentRenderTarget(i).texture),uTexVel:new u(l.getCurrentRenderTarget(o).texture)},s=[0,50];G({uSeparationR:{value:o.material.uniforms.uSeparationR.value,min:s[0],max:s[1],onChange(n){o.material.uniforms.uSeparationR.value=n},label:"分离半径"},uAlignmentR:{value:o.material.uniforms.uAlignmentR.value,min:s[0],max:s[1],onChange(n){o.material.uniforms.uAlignmentR.value=n},label:"对齐半径"},uCohesionR:{value:o.material.uniforms.uCohesionR.value,min:s[0],max:s[1],onChange(n){o.material.uniforms.uCohesionR.value=n},label:"聚集半径"},uCenterEdge:{value:o.material.uniforms.uCenterEdge.value,min:0,max:200,onChange(n){o.material.uniforms.uCenterEdge.value=n},label:"中心引力范围"},uSpeed:{value:[o.material.uniforms.uMinSpeed.value,o.material.uniforms.uMaxSpeed.value],min:1,max:400,onChange([n,f]){o.material.uniforms.uMinSpeed.value=n,o.material.uniforms.uMaxSpeed.value=f},label:"速度"}});const y=g.useRef(null);I(()=>{l.compute(),m.uTexPos.value=l.getCurrentRenderTarget(i).texture,m.uTexVel.value=l.getCurrentRenderTarget(o).texture,y.current.map=l.getCurrentRenderTarget(o).texture});const T=g.useMemo(()=>Array.from({length:v}).map((n,f)=>{const j=f;let p=H(f/c),R=(f-p*c+.5)/c;return p=(p+.5)/c,{instanceId:j,texCoord:[R,p]}}),[v,c]);return e.jsxs(e.Fragment,{children:[e.jsxs("mesh",{scale:3,visible:!1,children:[e.jsx("planeGeometry",{}),e.jsx("meshBasicMaterial",{side:q,ref:y})]}),e.jsxs(r,{limit:1e3,range:1e3,geometry:x["Freedom-Sworn_mesh_Freedom-Sworn_0001"].geometry,children:[e.jsx(F,{baseMaterial:N,map:t["Freedom-Sworn"].map,uniforms:m,vertexShader:B,fragmentShader:Z}),e.jsx(_,{name:"instanceId",defaultValue:0}),e.jsx(_,{name:"texCoord",defaultValue:[0,0]}),T.map(n=>e.jsx(a,{scale:.2,instanceId:n.instanceId,texCoord:n.texCoord},n.instanceId))]})]})}const ye=V(function(){return e.jsxs("div",{className:"h-screen",children:[e.jsxs(M,{children:[e.jsx("ambientLight",{}),e.jsx(E,{}),e.jsx(g.Suspense,{fallback:null,children:e.jsx(W,{})}),e.jsx(L,{children:e.jsx(A,{})})]}),e.jsx(U,{})]})});export{ye as default};
