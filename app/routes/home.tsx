    ...
    <>
      ...
      <div className='py-20 px-10 '>
        ...
        <div className='grid relative grid-cols-1 gap-y-8 sm:grid-cols-4 sm:gap-x-8'>
          <h1 data-type='mag' className='text-7xl col-span-full w-fit mb-10 text-amber-50'>
            THREE.js
          </h1>
          ...
          <LinkImg to='/webgpu/flight' img='/img/preview/53.png' />
          <LinkImg to='/webgpu/mouse-grass' img='/img/preview/54.png' />
          <LinkImg to='/webgpu/link-alien-bone' img='/img/preview/55.png' />
          <LinkImg to='/webgpu/line-spider' img='/img/preview/56.png' />
          <LinkImg to='/webgpu/line-spider-2' img='/img/preview/57.png' />
          <LinkImg to='/webgpu/line-ball' img='/img/preview/58.png' />
