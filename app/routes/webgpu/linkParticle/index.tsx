...
export default function () {
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      conRef.current.appendChild(renderer.domElement)
      ...
      partFolder
        .add(particleLifetime, 'value', 0.01, 2.0, 0.01)
        .name('Lifetime')
  ...
  return <div ref={conRef} className='h-screen'></div>
}
