import{r as l,w as T,o as t}from"./chunk-EPOLDU6W-D-U-5P6E.js";import{al as F,a as A,b8 as L,b9 as q,ba as M,bb as S,u as y,aG as _,aC as E,aA as P,y as d,C as G,O as I,bc as U,as as N,U as V,d as B,e as R}from"./OrbitControls-wRqzCdd_.js";import{a as h}from"./asset-BvcpElq9.js";import{P as k}from"./Perf-BYAwScHX.js";import{u as O,b as v}from"./leva.esm-BV3Tl-wj.js";import{j as Y}from"./three-custom-shader-material.es-00gjT4E9.js";import{u as X}from"./useUniformTime-iwv4e6ER.js";import{L as H,C as W}from"./Center-aYtwsplU.js";import{u as Z}from"./Texture-BQgsBGTv.js";import"./index-7OC5HNn7.js";import"./index-n5PR1bfd.js";import"./client-EdRjCdko.js";import"./index-D369hMBv.js";import"./three-custom-shader-material.es-WfkYmuit.js";const g=1024,f=g/2,e={lerpV:.3,listener:null,buffer:null,sound:null,analyser:null,freqData:new Float32Array(f),refCount:0,dataTex:null};function J(){const a=new _(e.freqData,f,1,E,P);a.minFilter=d,a.magFilter=d,a.needsUpdate=!0,e.dataTex=a}function K(a){const{camera:r}=F();e.buffer=A(L,a),l.useEffect(()=>(e.refCount===0&&(J(),e.listener=new q,r.add(e.listener),e.sound=new M(e.listener),e.sound.setBuffer(e.buffer),e.sound.setLoop(!0),e.sound.setVolume(.5),e.analyser=new S(e.sound,g)),e.refCount++,()=>{e.refCount--,e.refCount===0&&(e.sound?.stop(),e.listener&&r.remove(e.listener),e.sound=null,e.listener=null,e.analyser=null)}),[e.buffer]),y(()=>{e.sound?.isPlaying&&(o(),e.dataTex&&(e.dataTex.needsUpdate=!0))});function o(){if(!e.analyser)return;const c=e.analyser.getFrequencyData();for(let i=0;i<f;i++){const u=c[i]/255*e.lerpV+e.freqData[i]*(1-e.lerpV);e.freqData[i]=u}}return{get sound(){return e.sound},get analyser(){return e.analyser},get lerpFreqData(){return e.freqData},get dataTex(){return e.dataTex},set lerpV(c){e.lerpV=c}}}const Q=`#define GLSLIFY 1
//
