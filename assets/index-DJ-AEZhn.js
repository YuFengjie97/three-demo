...
悟性开启方知晓，玄妙深藏在此间。
`,{random:d,floor:k}=Math;function R(){const u=M("/font/ttf/subset-STXINWEI.TTF"),c=q.split(/\n\s|，/),v=400,a=e.useMemo(()=>Array.from({length:v},(o,n)=>{const i=c[k(d()*c.length)],t=(d()-.5)*20,x=(d()-.5)*15,y=-d()*15;return{str:i,pos:[t,x,y]}}),[v]),m={..._()},l=e.useMemo(()=>new E({uniforms:m,baseMaterial:L,vertexShader:G,fragmentShader:N,side:I,transparent:!0,alphaTest:.1,depthWrite:!1,blending:A}),[]);function f(o){return function(n){const i=n.geometry,t=i.getAttribute("position").count,x=new Float32Array(t).fill(o);i.setAttribute("aTextId",new S(x,1))}}return a.map((o,n)=>s.jsx(U,{position:o.pos,font:u,material:l,onSync:f(n),children:o.str},n))}const J=z(function(){return e.useRef(null),s.jsx("div",{className:"h-screen",children:s.jsxs(T,{children:[s.jsx("fog",{attach:"fog",args:["#000000",10,20]}),s.jsx("directionalLight",{position:[0,5,10]}),s.jsx(R,{}),s.jsx(j,{children:s.jsx(D,{delay:[2,2.5],duration:[.1,.12],strength:[.2,.3],ratio:.85})})]})})});export{J as default};
