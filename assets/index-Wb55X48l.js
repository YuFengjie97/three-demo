import{w as j,o as e,r as u}from"./chunk-EPOLDU6W-D-U-5P6E.js";import{am as M,an as b,ao as T,R as I,C as D,O as _,X as z,p as L,q as E,U,M as S,ap as k}from"./OrbitControls-buyHw8F8.js";import{a as P}from"./BufferGeometryUtils-BuJKPO1x.js";import{u as B}from"./leva.esm-BV3Tl-wj.js";import{P as F}from"./Perf-2bt_PeaC.js";import{a as c}from"./asset-BvcpElq9.js";import{j as G}from"./three-custom-shader-material.es-iuk4jPUE.js";import{u as R}from"./useUniformTime-CGcSBxmi.js";import{u as O}from"./Gltf-CySBEL9E.js";import{u as d}from"./Texture-cDJ2PIUO.js";import{E as q}from"./Environment-BCk0A5Rr.js";import"./index-7OC5HNn7.js";import"./index-D369hMBv.js";import"./client-EdRjCdko.js";import"./index-n5PR1bfd.js";import"./three-custom-shader-material.es-BzJpHPF7.js";function N(a){const{width:o,height:i}=a[0],l=a.length,f=o*i*4,p=new Uint8Array(f*l);a.forEach((y,g)=>{const m=document.createElement("canvas");m.width=o,m.height=i;const r=m.getContext("2d");r.drawImage(y.image,0,0);const n=r.getImageData(0,0,o,i).data;p.set(n,g*f)});const s=new M(p,o,i,l);return s.format=b,s.type=T,s.needsUpdate=!0,s.wrapS=I,s.wrapT=I,s}const Y=`#define GLSLIFY 1
//
